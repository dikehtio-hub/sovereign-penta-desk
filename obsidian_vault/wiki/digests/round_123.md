...
sources:
- id: agents-log
  resource: AGENTS_ARCHIVE.md#round-123-complete
  title: AGENTS_ARCHIVE.md - Round 123 complete
...
> 2026-09-07 13:10 EDT, Antigravity's R123-1.A directive · compiled from `AGENTS_ARCHIVE.md`. **The log is the record**; this page is an index into it, and loses to it wherever they disagree.
