...
sources:
- id: agents-log
  resource: AGENTS.md#round-104-complete
  title: AGENTS.md - Round 104 complete
...
> 2026-09-06, corrected in 104b · compiled from `AGENTS.md`. **The log is the record**; this page is an index into it, and loses to it wherever they disagree.
