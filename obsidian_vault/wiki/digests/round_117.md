...
sources:
- id: agents-log
  resource: AGENTS_ARCHIVE.md#round-117-complete
  title: AGENTS_ARCHIVE.md - Round 117 complete
...
> 2026-09-06, SELF-DIRECTED addendum, stopped at the authorisation boundary · compiled from `AGENTS_ARCHIVE.md`. **The log is the record**; this page is an index into it, and loses to it wherever they disagree.
