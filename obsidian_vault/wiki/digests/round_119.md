...
sources:
- id: agents-log
  resource: AGENTS_ARCHIVE.md#round-119-complete
  title: AGENTS_ARCHIVE.md - Round 119 complete
...
> 2026-09-06, INCIDENT, operator-authorised restart · compiled from `AGENTS_ARCHIVE.md`. **The log is the record**; this page is an index into it, and loses to it wherever they disagree.
