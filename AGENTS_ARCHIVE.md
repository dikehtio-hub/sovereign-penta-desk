# AGENTS_ARCHIVE.md — Superseded Handoff History and Operational Archive

This file holds historical handoff logs, section rulings, and round summaries superseded from `AGENTS.md`.
Nothing is deleted; full historical reasoning, empirical audits, and benchmarks remain completely recoverable.
Rotated on 2026-09-20 to keep `AGENTS.md` lean (<100 KB) for token conservation across agent sessions.
