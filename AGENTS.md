...
(5) FULL RULINGS ARCHIVED: ANTIGRAVITY_ARCHIVE.md (Sections 10-11) & ANTIGRAVITY_PROMPT.md (Section 12): Holdout promotion floor >= 6 months / >= 50 trades; AST detector refined to price-scaled quantities; monotonic deflated hurdle max(0.05, 0.05 * sqrt(ln(1+n))); functional group ablation required; Campaign 3 fold consistency locked at >= 6/8 (binomial alpha = 0.145).
