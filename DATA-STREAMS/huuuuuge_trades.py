...
websocket_url_base = 'wss://fstreeam.binance.com/ws/'
...
class TradeAggregator:
    ...
    async def check_and_print_trades(s):
        ...
        for trade_key, usd_size in self.trade_buckets.items():
            ...
            if second < timestamp_now and usd_size > 500000:
                ...
                if usd_size > 3000000:
                    ...
                    usd_size = usd_size
                    crpint(f"{trade_type} {symbol} {second} ${usd_size:2f}m", 'white', back_color, attrs=attrs)
    ...
    async with connect(uri) as websocket:
         while True:
            ...
            async def main():
                ...
                trade_stream_tasks = [binance_trade_stream(f"{websocket_url_base}{symbol}@aggrtrade", symbol, filename, trade_aggregator) for symbol in symbols]
